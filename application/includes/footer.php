...
<footer class="text-center text-lg-start text-muted">
  ...
  <section class="container d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    ...
    <!-- Right -->
    <div>
      <a href="https://www.facebook.com/chubbygourmet/" class="me-4 link-secondary" target="_blank">
        <i class="fab fa-facebook-f"></i>
      </a>
      <a href="https://www.instagram.com/chubby_gourmet/?fbclid=IwAR0ZqFa8j255NXBCpPWukIiKkMkvLJZeVyhSHy9jpgFDvXG3rH5oXY2nkEg" class="me-4 link-secondary" target="_blank">
        <i class="fab fa-instagram"></i>
      </a>
      <a href="mailto:chubbygourmet@gmail.com" class="me-4 link-secondary">
  ...
  <!-- Section: Links  -->
  <section class="">
    <div class="container footer-content text-center text-md-start mt-5">
      <!-- Grid row -->
      <div class="row mt-3">
        <!-- Grid column -->
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          <!-- Content -->
          <img src="assets/images/cgwhiteoutline.png">
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="category.php" class="text-reset">Menu</a>
          </p>
          <p>
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#terms">Terms and Conditions</a>
          </p>
          <p>
            <a style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#data-privacy">Privacy Policy</a>
          </p>
          <a class="text-light" href="mailto:chubbygourmet@gmail.com">
            Help
          </a>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p>
            <a class="text-light" href="https://www.google.com/maps/place/Chubby+Gourmet/@14.2669199,121.0689595,17z/data=!4m12!1m6!3m5!1s0x0:0xfdaa944833f8d521!2sChubby+Gourmet!8m2!3d14.2667779!4d121.069055!3m4!1s0x0:0xfdaa944833f8d521!8m2!3d14.2667779!4d121.069055" target="_blank">
              <i class="fas fa-home me-3 "></i> Sta. Rosa Laguna, PH</a>
          </p>
          <p>
          <a class="text-light" href="mailto:chubbygourmet@gmail.com">
            <i class="fas fa-envelope me-3 "></i>chubbygourmet@gmail.com
          </a>
          </p>
          <p><a class="text-light" href="tel:0917-234-5688"><i class="fas fa-mobile me-3"></i>0917-234-5688</a></p>
          <p><a class="text-light" href="tel:+852-98-76"><i class="fas fa-phone me-3 "></i>+852-98-76</a></p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
...
<div class="modal fade data-privacy" id="data-privacy" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
